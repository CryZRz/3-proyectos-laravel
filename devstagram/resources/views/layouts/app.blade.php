...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-gray-200">
            ...
            <div class="container mx-auto flex justify-between">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a 
                            class="flex items-center gap-2 bg-white p-2 text-gray-600 rounded text-sm uppercase font-bold" 
        ...
        <main class="container mx-auto mt-10">
            <h2 class="text-center font-bold mb-10 text-3xl">@yield("titulo")</h2>
            @yield("contenido")
        </main>
